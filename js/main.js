...
function createCard(records){
    ...
    records.forEach(function(el){
        htmlStr += "<div class=\"col-sm-6 col-md-4 col-lg-3 mt-4\"><div class=\"card\">";
        htmlStr += "<img class=\"card-img-top\" src=\""+el['image_path']+"\">" ;
        ...
        htmlStr += "<div class=\"card-text\">"+el['proj_description']+"</div><div class=\"card-footer\"><small>"+el['last_updated']+"</small>";
        htmlStr += "<button class=\"btn btn-secondary btn-md\" id =\"btn-today\">Read More <span><i class=\"glyphicon glyphicon-star\"></i></span></button></div></div></div>";
    });

    $("#project_row").html("<strong>Hello</strong>");
}