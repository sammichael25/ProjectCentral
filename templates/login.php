            ...
            <div id="signupbox" style="display:none; margin-top:60px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="panel panel-default" id="panel-default">
                            ...
                            <div class="panel-body" >
                                <form id="signupform" enctype="multipart/form-data"  class="form-horizontal" role="form" method="POST" action="index.php/signup">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" id="password2" class="form-control" name="password2" placeholder="Password Re-entry">
                                        </div>
                                    </div>
